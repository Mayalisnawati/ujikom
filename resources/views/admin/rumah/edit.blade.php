        ...
        <form action="{{ route('rumah.update', $rumahs->id) }}" method="post">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_rumah"
                                class="form-control mb-2  @error('nama_rumah') is-invalid @enderror" placeholder="Nama Rumah"
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="spesifikasi"
                                class="form-control mb-2  @error('spesifikasi') is-invalid @enderror" placeholder="Spesifikasi"
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="konfirmasi"
                                class="form-control mb-2  @error('konfirmasi') is-invalid @enderror" placeholder="Konfirmasi"
                ...
                <div class="d-flex float-start">
                    <a href="/admin/kategori" class="btn btn-danger me-3"><svg xmlns="http://www.w3.org/2000/svg"
