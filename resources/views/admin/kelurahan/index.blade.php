...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ Route('kelurahan.create') }}" class="btn mb-3 btn-primary float-end" data-bs-toggle="tooltip"
                                    ...
                                    <td>
                                        <form action="{{ route('kelurahan.destroy', $kelurahan->id) }}" method="post">
                                            ...
                                            <a href="{{ route('kelurahan.edit', $kelurahan->id) }}"
                                                class="btn btn-sm btn-success" data-bs-toggle="tooltip" data-bs-offset="0,4"
                                                data-bs-placement="top" data-bs-html="true" title="<span>Edit Data</span>">
