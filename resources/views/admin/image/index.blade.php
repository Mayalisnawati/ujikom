...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ Route('image.create') }}" class="btn mb-3 btn-primary float-end" data-bs-toggle="tooltip"
                        ...
                        @if (count($images))
                            @foreach ($images as $image)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            {{ $image->rumah->nama_rumah }}
                                        </div>
                                    </td>
                                    <td>
                                        <img src="{{ $image->image() }}" style="width: 100px; height:100px;" alt="">
                                    </td>
                                    ...
                                    <td>
                                        <form action="{{ route('image.destroy', $image->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('image.edit', $image->id) }}" class="btn btn-sm btn-secondary"
